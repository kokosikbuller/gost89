...
var Gost = function (sbox) {
  var mem = new window.Uint32Array(1162);
...
Gost.prototype.crypt_cfb = function (iv, clear, out) {
  ...
  this.gamma = new window.Uint8Array(8);
  var cur_iv = new window.Uint8Array(8);
  for (idx = 0; idx < 8; idx++) {
    cur_iv[idx] = iv[idx];
  }
...
Gost.prototype.mac = function (len, data, out) {
  var buf = new window.Uint8Array(8),
    buf2 = new window.Uint8Array(8);
