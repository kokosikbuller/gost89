...
var key_wrap = function (cek, kek, iv) {
  ...
  var icv,
    cekicv = new window.Uint8Array(40),
    temp1,
    temp2 = new window.Uint8Array(44),
    temp3 = new window.Uint8Array(48),
    result;
...
var key_unwrap = function (wcek, kek) {
  ...
  var icv = new window.Uint8Array(4),
    iv = new window.Uint8Array(8),
    cekicv,
    temp1 = new window.Uint8Array(40),
